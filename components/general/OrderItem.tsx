                ...
                <div className="flex flex-col gap-2 sm:flex-row sm:justify-between">
                    <div className="flex-1">
                        ...
                        <div className="mt-2 flex flex-wrap gap-1.5">
                            <span
                                className="sm-text rounded-lg border bg-neutral-100 px-2 py-1 text-xs"
                            >
                    ...
                    <div className="mt-2 flex items-center gap-2 sm:mt-0 sm:ml-4 sm:flex-col sm:items-end">
                        <p className="font-medium text-neutral-900">NRs.{item.product.price}</p>
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:gap-4">
                        ...
                        <p className="large-text font-semibold text-neutral-900">
                            Total: NRs.{(item.price * item.quantity).toFixed(2)}
                        </p>
                    </div>
