...
export const BuildOrderPayload = (
    ...
    return {
        ...
        payment: {
            paymentMethod: payment === 'khalti' ? PaymentMethod.Khalti : PaymentMethod.CashOnDelivery,
            amount: total,
...
export const BuildKhaltiPayload = (
    selectedItems: { productId: number; price: number; quantity: number; product: Product }[],
    ...
    return {
        ...
        website_url: process.env.NEXT_PUBLIC_CLIENT_URL ?? window.location.origin,
        ...
        customer_info: {
            ...
            phone: user?.phoneNumber ?? process.env.NEXT_PUBLIC_FALLBACK_PHONE ?? '9800000000',
        },
        amount_breakdown: [
