...
const OrderDetailTablePage = () => {
    ...
    const updateOrderMutation = useMutation({
        ...
        onSuccess: () => {
            ...
            dispatch(showNotification({ message: 'Order updated successfully', type: 'success' }));
        },
        onError: (error: unknown) => {
            if (isAxiosError(error)) {
                ...
                dispatch(showNotification({ message: 'Failed to update order. Please try again.', type: 'error' }));
            }
        },
    });
    ...
    if (orderError) return <div className="error-text">Failed to load order.</div>;
        ...
        <div className="content-wrapper space-y-10">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex flex-col gap-2">
                    <Button variant="outline" text="Back" onClick={() => router.push('/')} />
                    <span
            ...
            <ConfirmationModal
                ...
                onConfirm={() => onUpdate(OrderStatus.Pending)}
                title="Cancel Order"
                    ...
                    <div className="border-neutral rounded-xl border p-6">
                            ...
                            <tbody>
                                {orderData.orderItems.map((item) => (
                                    ...
                                    >
                                        ...
                                        <td className="py-2 px-3 text-sm">NRs.{item.price}</td>
                        ...
                        <div className="ml-auto w-full max-w-[320px] space-y-2 pt-4">
                            ...
                            <div className="flex justify-between border-t py-2 text-base font-medium text-neutral-dark">
                                <span>Total</span>
                                <span>NRs.{orderData.totalAmount.toFixed(2)}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="border-neutral rounded-xl border p-6">
                        ...
                        <div className="sm-text space-y-2">
                            <div className="flex justify-between">
                                ...
                                <span className="font-medium">{orderData.payment.paymentStatus}</span>
                            </div>
                            <div className="flex justify-between">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span>{orderData.payment.paidAt ? formatDate(orderData.payment.paidAt) : 'N/A'}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    <div className="border-neutral rounded-xl border p-6">
                        ...
                        <div className="space-y-2 text-sm text-shadow-neutral-dark">
                            ...
                            <p className="flex flex-col">
                                <span className="font-bold">Phone</span> {orderData.user?.phoneNumber}
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="flex flex-wrap justify-end gap-3">
                {orderData.status !== OrderStatus.Pending && (
                    <Button onClick={() => setShowConfirmModal(true)} variant="outline" text="Cancel Order" />
                )}
