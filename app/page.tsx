  ...
  return (
    <div className="flex flex-col gap-10 tablet:gap-20">
      <div className="flex flex-col-reverse gap-4 laptop:flex-row laptop:justify-between">
        ...
        <div
          className={`w-full laptop:w-[75%] max-h-[271px] min-h-[271px] tablet:max-h-96 tablet:min-h-96 pt-8 relative text-primary-50 flex pl-10 laptop:pl-20 border-2 bg-black justify-between`}
        >
          <div className={`${slideClass} flex justify-between w-full`}>
            <div className="flex flex-col gap-3 tablet:gap-4 ">
              ...
              <span
                className="text-lg tablet:text-4xl font-bold laptop:[line-height:3rem]"
            ...
            <img
              className="w-4/7 mt-6 h-32 tablet:h-72 hover:scale-130 transition-all ease-in-out duration-300 object-center"
